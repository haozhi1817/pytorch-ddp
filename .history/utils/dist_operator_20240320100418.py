...
# def ring_all_reduce(rank_id):
#     """
#     ring_all_reduce 1. 将每一个进程上的数据等分为N份，2. 经过N次for循环，执行两两reduce操作，3. 通过all gather同步结果。
#     """
#     tensors = torch.arange(rank_id * 4, (rank_id + 1) * 4)
#     tensors = torch.chunk(tensors, chunks=4)
